...
const i18n = {
  fr: {
    ...
    email_client: 'Email client', telephone_client: 'Téléphone client', ph_email_client: 'client@email.fr', ph_tel_client: '06 ...',
  ...
  tr: {
    ...
    email_client: 'Müşteri e-posta', telephone_client: 'Müşteri telefonu', ph_email_client: 'client@email.fr', ph_tel_client: '06 ...',
...
function calculerCarreleur(e) {
  ...
  const chantier = creerChantierCommun({
    metier: 'Carreleur', client: getInput('client-carrelage'), adresse: getInput('adresse-carrelage'), email: getInput('email-carrelage'), telephone: getInput('telephone-carrelage'),
...
function calculerPlaquiste(e) {
  ...
  const finance = buildFinance(surface, prixDetail.prixM2, remisePourcent, montantSup, tauxTva, prixDetail.lignes);
  const chantier = creerChantierCommun({
    metier: 'Plaquiste', client: getInput('client-placo'), adresse: getInput('adresse-placo'), email: getInput('email-placo'), telephone: getInput('telephone-placo'), details: `${typePlaqueLabel}${remisePourcent > 0 ? ` | Remise : ${remisePourcent}%` : ''}`,
...
function creerChantierCommun({ metier, client, adresse, email, telephone, details, surface, tauxTva, remisePourcent, labelSup, montantSup, finance, colisage, prixDetaille, photo }) {
  return { numeroDevis: genererNumeroDevis(), metier, client: client || 'Client non renseigné', adresse: adresse || '', email: email || '', telephone: telephone || '', details, surface,
